...
<body>
    ...
    <div class="brand"><h1> ${myRestaurant.restName} Admin menu </h1>
    </div>
    ...
    <div class="row">
        <div class="box">
            ...
            <div class="col-md-6">
                ...
                <hr>
                <h2 class="intro-text text-center">
                    <strong>Add food to menu</strong>
                </h2>
                <hr>


                <form:form action="addFood.htm" commandName="addingFood" method="post">

                    Please enter food name and price below:<br>

                    <table>
                        <tr>
                            <td> Food name:</td></tr>
                        <tr>
                            <td><input type="text" size="20" name="FoodName" required/>
                    ...
                    <table>
                        <tr>
                            <td> Food price:</td></tr>
                        <tr>
                            <td><input type="number" size="10" name="FoodPrice" required/>
                    ...
                    <table>
                        <tr>
                            <td> Number of Food:</td></tr>
                        <tr>
                            <td><input type="number" size="10" name="numberOfFood" required/>
