    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-md-6">
                    <p>Welcome to your home page. Thank you for loging in to  'Table and Food reservation'</p>
                    <p>You can add you restaurants to the system and help users reserve their tables and food online.</p>
                </div>
