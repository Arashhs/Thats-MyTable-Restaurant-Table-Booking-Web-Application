    ...
    <div class="row">
        <div class="box">
            ...
            <div class="col-lg-12 text-center">
                ...
                <h1>The restaurant Menu is as follows:<br></h1><br>
                <c:forEach items="${restList }" var="restaurant">
                    <table align="center" border=1>
                        <tr>
                            ...
                            <th>Food price</th>
                            <th>number</th>
                            <th>Confirm choosing</th>

                        </tr>
                        <c:forEach items="${restaurant.restFood }" var="food">

                            <c:if test = "${food.availability != 0}">
                                ...
                                <tr>
                                    ...
                                    <form:form action ="chooseTable.htm" commandName="choose" method="post"  >
                                        <td><input type="submit" value="Choose Food"/></td>
